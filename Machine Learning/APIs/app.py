...
def FertRecommend():
    ...
    'PHigh':"""The P value of your crop is high. 
    ...
    'Plow': """The P value of your crop is low. Please consider the following options.
    ...
    'KHigh': """ • Loosen the soil deeply with a shovel, and water thoroughly to dissolve water-soluble potassium. Allow the soil to fully dry, and repeat digging and watering the soil two or three more times.
